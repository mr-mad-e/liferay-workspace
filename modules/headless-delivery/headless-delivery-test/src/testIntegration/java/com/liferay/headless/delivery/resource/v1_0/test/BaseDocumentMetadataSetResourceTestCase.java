...
public abstract class BaseDocumentMetadataSetResourceTestCase {
	...
	protected Map<String, Map<String, String>>
		...
		createBatchAction.put(
			"href",
			"http://localhost:8080/o/x-headless-delivery/v1.0/asset-libraries/{assetLibraryId}/document-metadata-sets/batch".
	...
	protected Map<String, Map<String, String>>
		...
		createBatchAction.put(
			"href",
			"http://localhost:8080/o/x-headless-delivery/v1.0/sites/{siteId}/document-metadata-sets/batch".
